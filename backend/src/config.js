...
const extraMetadata = {
  external_url: "http://www.daynerds.wtf/", // Replace with your website or remove this line if you do not have one.
};
...
const PRESALE_WHITELISTED_ADDRESSES = ["0x7aF1b94a5697EBB0e64fB31c296f7273128a62Fd"]; // only update if you want to manually set the whitelisted addresses
